...
def create_payment(payment_in: PaymentCreate, session: DbSession) -> PaymentRead:
...
def patch_payment(payment_id: UUID, payment_in: PaymentUpdate, session: DbSession) -> PaymentRead:
...
def delete_payment(payment_id: UUID, session: DbSession) -> Response:
