...
async def create_school(school_in: SchoolCreate, session: DbSession, _admin: AdminUser) -> SchoolRead:
...
async def get_school(school_id: UUID, session: DbSession) -> SchoolRead:
...
async def patch_school(school_id: UUID, school_in: SchoolUpdate, session: DbSession, _admin: AdminUser) -> SchoolRead:
...
async def delete_school(school_id: UUID, session: DbSession, _admin: AdminUser) -> Response:
...
async def get_school_statement(school_id: UUID, session: DbSession) -> SchoolStatement:
    try:
